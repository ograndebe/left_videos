...
function _index(Scrubber,d3,data,duration){return(
...
function _chart(d3,width,height,data,max,$0,formatNumber,DOM,color,duration,parseNumber)
{
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("viewof index")).define("viewof index", ["Scrubber","d3","data","duration"], _index);
  main.variable(observer("index")).define("index", ["Generators", "viewof index"], (G, _) => G.input(_));
  main.variable(observer("chart")).define("chart", ["d3","width","height","data","max","viewof index","formatNumber","DOM","color","duration","parseNumber"], _chart);
  ...
  main.variable(observer("sums")).define("sums", ["data","d3"], _sums);
  main.variable(observer("max")).define("max", ["d3","sums"], _max);
